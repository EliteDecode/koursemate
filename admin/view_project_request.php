            ...
            <div class="col-md-10 col-lg-10 col-xl-10 ">
                <div class="row flex items-center justify-center">
                    <div class="col-lg-11 col-md-11">
                        ...
                        $id = $_GET['id'];
                        $result = selectOne('writters', ['id' => $id]);
                       $name = $result['Name'];
                       $email = $result['Email'];
                       $phone = $result['Phone'];
                       $project = $result['Project'];
                       $level = $result['EduLevel'];
                       $format = $result['ProjectFormat'];
                        $feedback = $result['Feedback'];
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="col-lg-12 col-md-12 my-3">
                                        <h2 class='text-sm font-semibold'>Project Format if any:</h2>
                                        <p><?php echo $format ?></p>
                                    </div>
                                    <div class="col-lg-12 col-md-12 my-3">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <?php if ($result['Status'] === 1):  ?>
                                    <button class="btn w-100 bg-red-600 text-white mt-2" id='decline-btn'
                                        onclick='decline()'>Decline
                                        Request</button>
                                    <?php elseif($result['Status'] === 0): ?>
                                    <div class="flex items-center justify-between">
                                        <button class="btn  bg-green-600 text-white mt-2" id='approve-btn'
                                    ...
                                    <?php elseif($result['Status'] === -1): ?>
                                    <button class="btn w-100 bg-green-600 text-white mt-2" id='approve-btn'
                                        onclick='Approve()'>Approve
                                        Request</button>
                                    <?php endif; ?>
        ...
        if (feedback !== "") {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: 'ajax_controls/admin_decline_request.php',
                        method: 'post',
                        data: {
                            id: request_id,
                            feedback: feedback,
        ...
        if (feedback !== "") {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    btn.html('Please wait...')
                    $.ajax({
                        url: 'ajax_controls/admin_approve_request.php',
                        method: 'post',
                        data: {
                            id: request_id,
                            feedback: feedback,
