...
function selectAllDistinct($table, $term, $conditions=[]){
...
function searchTrack($term, $filter){
  $match = "%" . $term . "%";

  global $conn;

   $sql = "SELECT DISTINCT $filter FROM courses WHERE  $filter LIKE ? AND Status = 1";
